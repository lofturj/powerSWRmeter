...
#define STARTUPDISPLAY3         "microwatts"
...
const int tft_DC            =  20;  // TFT LCD pins, using SPI2 - For optimized ILI9341_t3 library
const int tft_CS            =  21;
const int tft_MOSI          =   7;
const int tft_SCLK          =  14;
...
const int Pfwd              =  A2;  // (16) ADC1
const int Pref              =  A1;  // (15) ADC0
//
const int EncI              =   9;
const int EncQ              =  10;
const int EnactSW           =  11;  // Menu/Enact Switch
//
//const int frqCount        =  13;  // Take aside, use later for Frequency Counter input
//
const int R_Led             =  17;  // SWR Alarm
...
extern ILI9341_t3 tft;                        // To keep the .cpp stuff happy
